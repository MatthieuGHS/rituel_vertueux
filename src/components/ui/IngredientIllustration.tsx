...
const drawings: Record<IngredientId, ReactNode> = {
  framboise: (
    <>
      <path d="M32 18.5c-7.5 0-14.5 2.8-14.5 9.5 0 9.5 7 22.5 14.5 25 7.5-2.5 14.5-15.5 14.5-25 0-6.7-7-9.5-14.5-9.5Z" />
      {[
        [23, 25], [29, 25], [35, 25], [41, 25], [20, 30.5], [26, 30.5], [32, 30.5], [38, 30.5], [44, 30.5], [22.5, 36], [28.5, 36], [34.5, 36], [40.5, 36], [25.5, 41.5], [31.5, 41.5], [37.5, 41.5], [28.5, 47], [34.5, 47],
      ].map(([cx, cy]) => (
        <circle key={`${cx}-${cy}`} cx={cx} cy={cy} r="2.6" />
      ))}
      <path d="M32 18.5c-.5-4 .5-7.5 3-10" />
      <path d="M32 18.5c-3.5-3-8.5-3.5-12.5-1.2 4 .6 7.5 2.4 9.6 4.4" />
      <path d="M32 18.5c3.5-3 8.5-3.5 12.5-1.2-4 .6-7.5 2.4-9.6 4.4" />
      <path d="M32 18.5c-1.8 1.5-2.8 3.3-3 5.4M32 18.5c1.8 1.5 2.8 3.3 3 5.4" />
    </>
  ),
  hibiscus: (
    <>
